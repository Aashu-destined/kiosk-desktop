// Mocking the behavior to bypass native module issues

const ACCOUNTS = [
    { id: 1, name: 'Cash', type: 'ASSET', balance: 10000 },
    { id: 2, name: 'OD Account', type: 'LIABILITY', balance: 0 }, // Starts at 0 debt
...
const runScenario = () => {
    console.log("--- SIMULATION: KIOSK WITHDRAWAL (ON-US) ---");
    ...
    if (odAcc.balance < 0) {
        console.log("\n[OBSERVATION] OD Account Balance became NEGATIVE.");
        console.log("This means the Liability Decreased (became an Asset visually?).");
    } else {
        console.log("\n[OBSERVATION] OD Account Balance Increased.");
    }
};
